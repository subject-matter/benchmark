    ...
    <>
      <SmoothScrolling>
        <Container>
          ...
          <p className="col-span-6 md:col-span-2  font-medium text-sm mb-3 md:mb-0">Design and build architecture</p>
          ...
          <p className="font-medium text-sm md:text-lg col-span-12 my-medium">
            While the simple definition of home is the four walls and roof within which you live, the true meaning is
            found in the spaces you inhabit. Home is a place where you can laugh, experience and enjoy the day to-day.
            It is a space you love, you care for and that ultimately you have created. At Benchmark, we pride ourselves
            on helping you achieve this. Working with you to turn your wants and needs into a tangible reality is what
