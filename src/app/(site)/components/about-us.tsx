	...
	return (
		<section className={`fade-in-section md:mt-[300px] `} id="about-us-section">
			<div className="grid grid-cols-2 min-h-screen relative">
				<div className={`row-span-4 col-span-2 md:col-span-1 h-auto`}>
					{/* <div className="group">
						<div
							className={`hidden md:block  z-[1] pb-10  mx-[10px] md:mx-5 col-span-2  md:col-span-1`}
						>
							<p className="text-black text-xs-medium md:py-5 ">About Us</p>
						</div>

						<div className="numbers pb-8  z-[2] border-t border-dotted border-grey pt-3  mx-[10px] md:mx-5 col-span-2  md:col-span-1">
						...
						<div className="awards pb-8  z-[3] relative  border-t border-dotted border-grey pt-3  mx-[10px] md:mx-5 col-span-2 md:col-span-1 ">
						...
						<div
							className={`relative houses z-[5] border-t border-dotted border-grey pt-3 pb-24  mx-[10px] md:mx-5 fade-in-section `}
						>
							...
							<div className={`py-32 md:mb-0 px-[10px] md:px-0`}>
								<AboutAccordions />
					...
					<div className="group">
						<div className="numbers pb-8 bg-white z-[2]   mx-[10px] md:mx-5 col-span-2  md:col-span-1">
							<div
								className={`hidden md:block  z-[1] col-span-2  md:col-span-1`}
							>
								<p className="text-black text-xs-medium md:py-5 ">About Us</p>
							</div>
							<h4 className="pt-3 text-xs-medium border-t  border-dotted border-grey">
								Years of Experience
							</h4>
				...
				<div
					className={`bg-black text-white h-screen z-[5] pl-3 col-span-2 md:col-span-1 md:row-start-7 border-r border-grey border-dotted md:sticky top-0 row-span-6 `}
				>
				...
				<div className="md:bg-black  col-span-2 row-start-1 md:col-start-2 row-span-6 relative order-1 ">
