...
function AboutSection() {
  ...
  useEffect(() => {
		setIsVisible(false);
		const timeout = setTimeout(() => setIsVisible(true), 0); // Short delay for the fade effect
			...
			<div className="grid grid-cols-2 min-h-screen relative">
				...
				>
					<div className={`h-screen flex flex-col justify-end sticky top-0`}>
						...
						>
							<h1 className="font-medium text-sm-xl md:text-xl mb-medium absolute bottom-1/3">
						...
						<Link
							href="/about-us"
							className="mt-[60px] w-fit bg-[#F5F5F5] rounded-[5px] flex text-xxs p-[10px] cursor-pointer hover:opacity-50 transition col-span-6 text-black"
						>
							Learn more
							<div className="ml-[50px] flex items-center">
								<svg
