  ...
  return (
    <footer className="bg-transparent" id="footer">
      <div className="footer-container mx-auto  grid w-full grid-cols-12 gap-x-5 bg-white text-xs-medium lg:p-5 ">
        ...
        <div className="lg col-span-9 col-start-1 flex flex-col  text-base lg:col-span-3 lg:col-start-10 px-[10px] lg:mb-[233px]">
          <a
            href="/"
        ...
        <div className="col-span-4 ml-auto lg:ml-0 col-start-9 md:col-start-10 flex gap-x-1  lg:mr-[15px] px-[10px]  row-start-3 ">
          <SocialIcons />
        </div>
        ...
        <div className="col-span-12 row-start-4 grid grid-cols-12 items-end gap-x-5">
          ...
          />
          <div className="col-span-12  mt-auto bg-black py-[10px] pl-[10px] md:pl-0 text-[12px] font-medium leading-[14px]  text-[#999999] lg:col-span-3 lg:col-start-10 lg:mt-0 lg:bg-white lg:py-0 lg:text-xxs lg:leading-normal lg:text-black">
