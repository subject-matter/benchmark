  ...
  return (
    <footer className="bg-transparent" id="footer">
      <div className="footer-container mx-auto  grid w-full grid-cols-12 gap-x-5 bg-white text-xs-medium lg:p-5 ">
        ...
        <div className="px-[10px] col-span-9 col-start-1 flex flex-col  text-base lg:col-span-3 lg:col-start-10 lg:mb-[233px]">
          <a
            href="/"
        ...
        <div className="col-span-4 px-[10px] ml-auto lg:ml-0 col-start-9 md:col-start-10 flex gap-x-1  lg:mr-[15px]  row-start-3 ">
          <SocialIcons />
        </div>
