      ...
      const pin = gsap.fromTo(
        ...
        },
        {
          ...
          scrollTrigger: {
            ...
            // end: () => '+=' + (sectionRef.current.scrollWidth - innerWidth),
            // markers: true,
            scrub: 1,
            snap: {
              snapTo: 0.333333,
        ...
        <div className="bg-white absolute px-[10px] md:px-5  grid grid-cols-12 mt-[10px] md:mt-5 items-start w-full transition duration-500 z-[1]">
          ...
          <span className="col-start-1 md:col-start-10 col-span-12 md:col-span-3 mt-5 md:mt-0 md:ml-auto flex items-center md:justify-center">
            <div className="flex gap-x-[10px] gap-y-[10px] flex-wrap mb-5">
              <div id="area" className="bg-[#F5F5F5] rounded-[5px] p-[6px] text-xxs">
                220m2
              </div>
              <div id="bedrooms" className="bg-[#F5F5F5] rounded-[5px] p-[6px] text-xxs">
                3 Bedrooms
              </div>
              <div id="bathrooms" className="bg-[#F5F5F5] rounded-[5px] p-[6px] text-xxs">
                2 Bathrooms
              </div>
            </div>
          </span>
